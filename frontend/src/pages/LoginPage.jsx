...
//                 </div>
//                 </div>
//                 <button type='submit' className='btn btn-info w-full' disabled={isLoggingIn}>
//                   {isLoggingIn?(
//                     <>
...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="hidden min-h-screen lg:flex bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 text-white justify-center items-center rounded-r-3xl">
        <div className="p-10 max-w-lg text-center space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold">
            Welcome Back!
          </h2>
          <p className="text-base md:text-lg">
            Sign in for seamless communication with ur friend !
          </p>
